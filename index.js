...
const player2Turn = () => {
  //devolvemos la parte entera del numero removiendo cualquier digito decimal (digitos despues de la coma)
  // return the integer part of the number removing any decimal digits (digits after the comma)
  ...
  e.addEventListener("click", () => {
    ...
    if (!isGameOver) {
      if (player1Option === player2Option.name) {
        updateData(player1Element, player1Option.emoji);
